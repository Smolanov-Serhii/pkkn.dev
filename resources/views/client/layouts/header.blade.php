    ...
    <div class="header__container main-container">
        ...
        <nav id="header__nav" class="header__nav">
            <ul class="mobile-menu__list">
                <li class="mobile-menu__item @if($page->seo->alias == 'methods'){{'active'}}@endif"><a href="{{ local_url('methods') }}" class="mobile-menu__link">Методика</a></li>
                <li class="mobile-menu__item @if($page->seo->alias == 'trainings'){{'active'}}@endif"><a href="{{ local_url('trainings') }}" class="mobile-menu__link">Тренировки</a></li>
                <li class="mobile-menu__item @if($page->seo->alias == 'treners'){{'active'}}@endif"><a href="{{ local_url('treners') }}" class="mobile-menu__link">Тренера</a></li>
                <li class="mobile-menu__item @if($page->seo->alias == 'schedule'){{'active'}}@endif"><a href="{{ local_url('schedule') }}" class="mobile-menu__link">Расписание</a></li>
                <li class="mobile-menu__item @if($page->seo->alias == 'reviews'){{'active'}}@endif"><a href="{{ local_url('reviews') }}" class="mobile-menu__link">Отзывы</a></li>
                <li class="mobile-menu__item @if($page->seo->alias == 'blog'){{'active'}}@endif"><a href="{{ local_url('blog') }}" class="mobile-menu__link">Блог</a></li>
                <li class="mobile-menu__item @if($page->seo->alias == 'questions'){{'active'}}@endif"><a href="{{ local_url('questions') }}" class="mobile-menu__link">FAQ</a></li>
            </ul>
        </nav>
