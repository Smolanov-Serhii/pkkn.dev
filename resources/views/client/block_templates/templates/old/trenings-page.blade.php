...
<section class="trainings-page">
    <div class="trainings-page__container main-container">
{{--        <img id="image0" src="http://109.233.205.181:8081/mjpg/video.mjpg" class="img-responsive img-rounded detailimage" alt="">--}}
{{--        <br>--}}
{{--        <br>--}}
            ...
            @foreach($items as $item)
                ...
                <div class="trainings-page__item">
                    <div class="trainings-page__item-header">
                        ...
                        @if($properties['file'])
                            <a href="{{  url('/') . '/uploads/module_items/' . $properties['file'] }}" class="trainings-page__video fresco">
                                <svg width="111" height="111" viewBox="0 0 111 111" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="55.5" cy="55.5001" r="42.6154" stroke="#F6E04F" stroke-width="3"/>
                                    <circle cx="55.5" cy="55.5" r="55" stroke="#F6E04F"/>
                                    <path d="M39.4869 55.6026C39.4869 49.4236 39.4667 43.2446 39.4869 37.0656C39.5003 32.7222 41.8671 31.3304 45.6054 33.4819C56.3766 39.6744 67.1344 45.8803 77.8922 52.0996C81.5768 54.231 81.5969 57.1289 77.9393 59.2468C67.121 65.4998 56.296 71.746 45.4642 77.9721C41.9612 79.9892 39.5138 78.5907 39.4936 74.57C39.4667 68.243 39.4869 61.9228 39.4869 55.6026Z" fill="#F6E04F"/>
                                </svg>
                            </a>
                        @endif
                    </div>
                    ...
                    <div class="trainings-page__buttons">
                        ...
                        <div class="trainings-page__button button-stroke js-try">
