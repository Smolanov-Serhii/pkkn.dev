...
@foreach($items as $item)
    @if(!empty(array_intersect($module_item->taxonomy_items->map(function($item){return $item->name;})->toArray(),$item->taxonomy_items->map(function($item){return $item->name;})->toArray())))
    @php
