...
<section class="text-block" id="text-block">
    <div class="text-block__design">
        <img src="{{ url('/img/templates/slogan/perf.svg') }}" alt="Элемент дизайна">
    </div>
            ...
            <div class="text-block__buttons">
                ...
                <div class="downloads">
                    <a href="#" class="isDisabled">
                        <img src="{{ url('/img/templates/slogan/gp.jpg') }}" alt="Google Play Market">
                    </a>
                    <a href="#" class="isDisabled" >
                        <img src="{{ url('/img/templates/slogan/as.jpg') }}" alt="AppStore">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="text-block__img main-container" data-aos="fade-up">
        <img src="{{ url('/img/templates/slogan/mask-group.png') }}" alt="{{ $contents['title']['value'] }}">
    </div>
</section>