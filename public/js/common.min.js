...
$( document ).ready(function() {
    ...
    if ($(".production").length){
        var production = new Swiper(".production .swiper-container", {
            loop: true,
            spaceBetween: 20,
            slidesPerView: 4,
            freeMode: true,
            navigation: {
                nextEl: ".production__navigation-next",
                prevEl: ".production__navigation-prev",
            },
        });
    };
    ...
    if ($(".img-to-text").length){
        $(".img-to-text__img .show").click( function(e) {
            $(this).closest('.img-to-text__item').find('.img-to-text__content').addClass('active');
            $(this).closest('.img-to-text__item').find('.img-to-text__lnk').addClass('active');
            $(this).closest('.img-to-text__item').find('.img-to-text__close').addClass('active');
        });
        $(".img-to-text__close").click( function(e) {
            $(this).closest('.img-to-text__item').find('.img-to-text__content').removeClass('active');
            $(this).closest('.img-to-text__item').find('.img-to-text__lnk').removeClass('active');
            $(this).closest('.img-to-text__item').find('.img-to-text__close').removeClass('active');
        });
    };

    if ($(".works-page__rubrik").length){
        $(".works-page__rubrik").click( function(e) {
            $('.works-page__rubrik input[type="checkbox"]').prop('checked', false);
            $(this).find('input[type="checkbox"]').prop('checked', true);
            $('.works-page__rubrik').removeClass('active');
    ...
    if ($('.contacts').length){
        $( ".contacts__item-map" ).each(function( index ) {
            var FirstCoord = $(this).data('first');
            var SecondCoord = $(this).data('second');
            var CenterFirstCoord = FirstCoord;
            var CenterSecondCoord = SecondCoord;
            ymaps.ready(function () {

                var IconUrl = $('.contacts__list').data('icon');
